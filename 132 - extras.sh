...
system_record_etc_dir_changes "Locked irc,games,news,uucp,proxy,list,gnats accounts"
...
aptitude -y install vim less logrotate lynx mytop nmap ntop screen sqlite3 cron-apt ntp curl
